...
# payload and target. The playload should be an array
# or unique integer values(positive, negative, or 0).
# The target should be an integer(positive, negative, or 0).
# Your method/function should search through the payload to
# find any two numbers that add together to equal the target value.
...
#     => []
# Bonus: Once you’ve found a working solution,
# try to optimize to run in O(n) time and 1x space complexity.