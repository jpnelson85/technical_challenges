...
# You will be given a deeply nested array,
# or multi-dimensional array, that will look similar to either of the below:

#  nums = [1, 2, 3, [[4], 5], [[[6]]]]
#  words = ["hi", "this is", [[["string"], "that is very"], [[[["nested"]]]]]]

# The contents of the array are not significant.
# Your method/function should take an input of a multi-dimensional array and output a one-dimensional array.
